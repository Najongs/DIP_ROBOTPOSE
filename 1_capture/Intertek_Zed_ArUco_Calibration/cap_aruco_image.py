...
calib_json_path = f"./Calib_cam_from_conf/{camera_position}_{camera_serial}_{view_name}_calib.json"

with open(calib_json_path, "r") as f:
    calib_data = json.load(f)

camera_matrix = np.array(calib_data["camera_matrix"])
# adv_dist = calib_data["advanced_distortion"]
# distortion_coeffs = [adv_dist[key] for key in ["k1", "k2", "k3", "k4", "k5", "k6", "p1", "p2"]]
