...
출처: RoboPose [arXiv:2104.09359, github.com/ylabbe/robopose] · CtRNet [CVPR'23, arXiv:2302.14332] · CtRNet-X [ICRA'25, arXiv:2409.10441, sites.google.com/ucsd.edu/ctrnet-x].
...
| 방법 | mean AUC | 관절각 | bbox | 비고 |
|---|---|---|---|---|
| RoboPose | 73.2 | predicted | init 의존 | auto orb 32.7 |
| RoboTAG | 74.0 | predicted | **자동** | orb 58.8(auto 붕괴) |
| HoRoPose | 77.2 | predicted | — | root-depth |
| RoboPEPP | 77.9 | predicted | **GT-bbox** | auto orb≈34; 가림 최강(기존) |
| **Ours (재잠금)** | **80.4** | predicted | **완전 자동** | +DARK+cov-PnP; 가림 전 구간 RoboPEPP 초과 |
