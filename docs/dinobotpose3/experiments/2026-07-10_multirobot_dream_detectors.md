...
- 🔄 **angle+rotation head 학습 중**(GPU0/1). 예비 ADD(Ep~11): **ADD-AUC 0.25**, median 77mm. rot-head 우수(geo 5.7°/t-err 60mm, KUKA보다 좋음)이나 **wrist 각도(w0/w1) 병목**(J4/J5 27°/22° — 검출기 원위 link-혼동이 각도 head로 전파). KUKA(근위 혼동)와 정반대 약점. 수렴 시 auto-eval로 최종 측정.
