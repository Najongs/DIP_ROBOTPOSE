...
|---|---|---|---|---|---|
| **우리 (occaug+RC)** | **0.810** | **0.766** | **0.675** | **0.572** | **0.405** |
| RoboPEPP | 0.795 | 0.730 | 0.600 | 0.470 | 0.351 |

**전 가림 구간 RoboPEPP 초과** (+0.015~+0.102). 가림-증강 head(07-04)가 클린 do-no-harm이면서 이전에 지던 0%·40%를 뒤집음 — 가림 강건성이 RoboPEPP의 셀링포인트였는데 역전.
