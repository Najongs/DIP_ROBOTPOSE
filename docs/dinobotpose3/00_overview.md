...
|---|---|---|---|---|---|
| **우리 (light+RC)** | **0.812** | **0.765** | **0.678** | **0.575** | **0.429** |
| RoboPEPP | 0.795 | 0.730 | 0.600 | 0.470 | 0.351 |

**전 가림 구간 RoboPEPP 초과** (+0.017~+0.105). 가림-증강 head(07-04)가 클린 do-no-harm이면서 이전에 지던 0%·40%를 뒤집음 — 가림 강건성이 RoboPEPP의 셀링포인트였는데 역전.
