...
GPU2_UUID=GPU-ab38c04c-0adf-17eb-fc9f-fab2e28559f5
...
export CUDA_VISIBLE_DEVICES="${2:-$GPU2_UUID}"
export HF_HOME=/data/public/97_cache

TS=$(date +%Y%m%d_%H%M%S)
OUT_DIR="./outputs_angle/angle_tf_${TS}"
mkdir -p "$OUT_DIR"
