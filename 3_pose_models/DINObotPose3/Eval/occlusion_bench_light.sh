...
POSE_EXTRA="${POSE_EXTRA:-}"; RC_EXTRA="${RC_EXTRA:-}"; LABEL="${LABEL:-light}"
TAG=$(basename "$VAL")_r${R}_${LABEL}
...
python selfbbox_eval.py \
  ...
  --crop-angle ../TRAIN/outputs_angle/angle_occaug_light_20260704_015400/best_angle_head.pth \
  --rot-head ../TRAIN/outputs_rotation/rot_crop_occaug_20260704_002102/best_rot_head.pth \
