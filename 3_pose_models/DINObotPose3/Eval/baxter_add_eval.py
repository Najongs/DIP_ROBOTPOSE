"""Baxter-left keypoint-path ADD-AUC (7-DOF, DREAM kuka synth).
...
(model_v4.baxter_left_forward_kinematics, verified 0.003mm vs DREAM). Mirrors meca_add_eval.py.
...
from model_v4 import baxter_left_forward_kinematics, _BAXTER_LEFT_JOINT_LIMITS
from dataset import PoseEstimationDataset
from refine_eval import scale_K, add_auc, wrapped_abs_deg
import solve_pose_kinematic as spk

FK = baxter_left_forward_kinematics
KP_NAMES = ['left_s0','left_s1','left_e0','left_e1','left_w0','left_w1','left_w2']
ANGLE_JOINTS = ['left_s0','left_s1','left_e0','left_e1','left_w0','left_w1','left_w2']
...
def _patch_solver_for_baxter():
    spk.panda_forward_kinematics = baxter_left_forward_kinematics
    lims = _BAXTER_LEFT_JOINT_LIMITS
...
def main():
    ...
    print(f"\n{'='*60}\n  Baxter-left keypoint-path ADD  [{tag} | {mode}]  ({n} frames)\n{'='*60}")
