...
def main():
    ...
    # --- 1. 체크포인트 경로 및 시작 변수 설정 ---
    CHECKPOINT_DIR = "checkpoints"
    CHECKPOINT_PATH = os.path.join(CHECKPOINT_DIR, "2nd_best_model_heatmap_only_epoch_98.pth")
    start_epoch = 0
    ...
    for epoch in range(EPOCHS):
        ...
        if rank == 0:
            ...
            if avg_val_loss < best_val_loss:
                ...
                torch.save(model_to_save, f"checkpoints/best_model_heatmap_only_epoch_{epoch+1}.pth")
